                ...
                try
                {
                    ...
                    foreach (var row in user.Userpreferredrole)
                    {
                        using var command2 = new MySqlCommand(
                            "INSERT INTO userpreferredroles (User_id,Role_id) VALUES (@userId,@roleId)",
                            connection
                        );
                        ...
                        try
                        {
                            ...
                            foreach (var row in user.Userfamiliartech)
                            {
                                using var command3 = new MySqlCommand(
                                    "INSERT INTO userfamiliartech (User_id,Technologies_id) VALUES (@userId,@technologiesId)",
                                    connection
                                );
                                ...
                                try
                                {
                                    ...
                                    foreach (var row in user.Userexpertisetech)
                                    {
                                        using var command4 = new MySqlCommand(
                                            "INSERT INTO userexpertisetech (User_id,Technologies_id) VALUES (@userId,@technologiesId)",
                                            connection
                                        );
